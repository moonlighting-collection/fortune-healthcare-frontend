                ...
                <div className="mx-auto max-w-4xl justify-center px-6 xl:px-0">
                    ...
                    <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="">
                                <p className="mb-1 text-right text-lg font-bold">$134.98</p>
                                <p className="text-sm text-gray-700">including VAT</p>
                            </div>
                        </div>
                        <div className="flex gap-8 justify-around">
                            <button className="mt-6 w-full rounded-md border border-blue-500 py-1.5 font-medium text-blue-500 hover:border-blue-800 hover:text-blue-800">Empty Cart</button>
                            <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-white hover:bg-blue-600">Check out</button>
                        </div>
                    </div>
                </div>
            </div>
