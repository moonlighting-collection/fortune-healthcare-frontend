          ...
          <div className="flex justify-around pt-4">
              <button className="bg-gray-100 inline-flex py-2 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                ...
                <span className="ml-2 flex items-start flex-col leading-none">
                  <span className="text-[0.5rem] text-gray-600 mb-1">GET IT ON</span>
                  <span className="text-sm title-font font-medium">Google Play</span>
                </span>
              </button>
              <button className="bg-gray-100 inline-flex py-2 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                ...
                <span className="ml-2 flex items-start flex-col leading-none">
                  <span className="text-[0.5rem] text-gray-600 mb-1">Download on the</span>
                  <span className="title-sm font-medium">App Store</span>
                </span>
              </button>
            </div>
        </div>
