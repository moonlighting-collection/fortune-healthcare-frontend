    ...
    <footer className="bg-blue-400 text-gray-600 body-font">
      <div className="container px-5 py-20 mx-auto flex md:items-center lg:items-start md:flex-row md:justify-around md:flex-nowrap flex-wrap flex-col">
        <div className="md:w-[21rem] w-full px-4 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
          ...
          <p className="mt-2 text-sm text-gray-800 px-1">Air plant banjo lyft occupy retro adaptogen indego</p>
          <div className="flex mt-2 md:mt-4">
            <button className="bg-gray-100 inline-flex px-1 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 h-8" viewBox="0 0 32 32"><path d=" M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.1c-.802-.402-1.504-.817-2.163-1.447-.545-.516-1.146-1.29-1.46-1.963a.426.426 0 0 1-.073-.215c0-.33.99-.945.99-1.49 0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187 0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032 1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23 1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817 0 2.15-.515 2.478-1.318.13-.33.244-.73.244-1.088 0-.058 0-.144-.03-.215-.1-.172-2.434-1.39-2.678-1.39zm-2.908 7.593c-1.747 0-3.48-.53-4.942-1.49L7.793 24.41l1.132-3.337a8.955 8.955 0 0 1-1.72-5.272c0-4.955 4.04-8.995 8.997-8.995S25.2 10.845 25.2 15.8c0 4.958-4.04 8.998-8.998 8.998zm0-19.798c-5.96 0-10.8 4.842-10.8 10.8 0 1.964.53 3.898 1.546 5.574L5 27.176l5.974-1.92a10.807 10.807 0 0 0 16.03-9.455c0-5.958-4.842-10.8-10.802-10.8z" fillRule="evenodd"></path></svg>
              <span className="px-2 py-1 flex items-start flex-col leading-none">
                <span className="text-[0.5rem] text-gray-600 mb-1">Ask us on</span>
            ...
            <button className="bg-gray-100 inline-flex  rounded-lg items-center ml-4 hover:bg-gray-200 focus:outline-none">
              <span className="px-2 py-2 flex items-start flex-col leading-none">
                <span className="text-[0.5rem] text-gray-600 mb-1">Contact us</span>
                <span className="text-[0.9rem] font-medium">+1 672 2562 2526</span>
              </span>
            </button>
          </div>
        </div>
      ...
      <div className="bg-blue-700 text-white">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-sm text-center sm:text-left">© 2024 1StepCure —
            <a href="https://twitter.com/samprit" rel="noopener noreferrer" className=" ml-1" target="_blank">@samprit</a>
          </p>
